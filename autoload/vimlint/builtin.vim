...
let s:builtin_func.arglistid = {'min' : 0, 'max': 2}
let s:builtin_func.argv = {'min' : 0, 'max': 1}
let s:builtin_func.asin = {'min' : 1, 'max': 1}
let s:builtin_func.assert_beeps = {'min' : 1, 'max': 1}
let s:builtin_func.assert_equal = {'min' : 2, 'max': 3}
let s:builtin_func.assert_equalfile = {'min' : 2, 'max': 2}
let s:builtin_func.assert_exception = {'min' : 1, 'max': 2}
let s:builtin_func.assert_fails = {'min' : 1, 'max': 2}
let s:builtin_func.assert_false = {'min' : 1, 'max': 2}
let s:builtin_func.assert_inrange = {'min' : 3, 'max': 4}
let s:builtin_func.assert_match = {'min' : 2, 'max': 3}
let s:builtin_func.assert_notequal = {'min' : 2, 'max': 3}
let s:builtin_func.assert_notmatch = {'min' : 2, 'max': 3}
let s:builtin_func.assert_report = {'min' : 1, 'max': 1}
let s:builtin_func.assert_true = {'min' : 1, 'max': 2}
let s:builtin_func.atan = {'min' : 1, 'max': 1}
let s:builtin_func.atan2 = {'min' : 2, 'max': 2}
let s:builtin_func.balloon_show = {'min' : 1, 'max': 1}
let s:builtin_func.balloon_split = {'min' : 1, 'max': 1}
...
let s:builtin_func.bufnr = {'min' : 1, 'max': 2}
let s:builtin_func.bufwinid = {'min' : 1, 'max': 1}
...
let s:builtin_func.ch_canread = {'min' : 1, 'max': 1}
let s:builtin_func.ch_close = {'min' : 1, 'max': 1}
let s:builtin_func.ch_close_in = {'min' : 1, 'max': 1}
let s:builtin_func.ch_evalexpr = {'min' : 2, 'max': 3}
let s:builtin_func.ch_evalraw = {'min' : 2, 'max': 3}
let s:builtin_func.ch_getbufnr = {'min' : 2, 'max': 2}
let s:builtin_func.ch_getjob = {'min' : 1, 'max': 1}
let s:builtin_func.ch_info = {'min' : 1, 'max': 1}
let s:builtin_func.ch_log = {'min' : 1, 'max': 2}
let s:builtin_func.ch_logfile = {'min' : 1, 'max': 2}
let s:builtin_func.ch_open = {'min' : 1, 'max': 2}
let s:builtin_func.ch_read = {'min' : 1, 'max': 2}
let s:builtin_func.ch_readraw = {'min' : 1, 'max': 2}
let s:builtin_func.ch_sendexpr = {'min' : 2, 'max': 3}
let s:builtin_func.ch_sendraw = {'min' : 2, 'max': 3}
let s:builtin_func.ch_setoptions = {'min' : 2, 'max': 2}
let s:builtin_func.ch_status = {'min' : 1, 'max': 2}
...
let s:builtin_func.debugbreak = {'min' : 1, 'max': 1}
let s:builtin_func.deepcopy = {'min' : 1, 'max': 2}
let s:builtin_func.delete = {'min' : 1, 'max': 2}
let s:builtin_func.deletebufline = {'min' : 2, 'max': 3}
...
let s:builtin_func.execute = {'min' : 1, 'max': 1}
...
let s:builtin_func.getcompletion = {'min' : 2, 'max': 3}
let s:builtin_func.getcurpos = {'min' : 0, 'max': 0}
let s:builtin_func.getcwd = {'min' : 0, 'max': 2}
...
let s:builtin_func.glob = {'min' : 1, 'max': 4}
let s:builtin_func.glob2regpat = {'min' : 1, 'max': 1}
let s:builtin_func.globpath = {'min' : 2, 'max': 5}
let s:builtin_func.has = {'min' : 1, 'max': 1}
let s:builtin_func.has_key = {'min' : 2, 'max': 2}
let s:builtin_func.haslocaldir = {'min' : 0, 'max': 2}
...
let s:builtin_func.isnan = {'min' : 1, 'max': 1}
let s:builtin_func.items = {'min' : 1, 'max': 1}
let s:builtin_func.job_getchannel = {'min' : 1, 'max': 1}
let s:builtin_func.job_info = {'min' : 0, 'max': 1}
let s:builtin_func.job_setoptions = {'min' : 2, 'max': 2}
...
let s:builtin_func.matchstrpos = {'min' : 2, 'max': 4}
...
let s:builtin_func.perleval = {'min' : 1, 'max': 1}
let s:builtin_func.pow = {'min' : 2, 'max': 2}
let s:builtin_func.prevnonblank = {'min' : 1, 'max': 1}
let s:builtin_func.printf = {'min' : 2, 'max': 65535}
let s:builtin_func.prompt_addtext = {'min' : 2, 'max': 2}
let s:builtin_func.prompt_setcallback = {'min' : 2, 'max': 2}
let s:builtin_func.prompt_setinterrupt = {'min' : 2, 'max': 2}
let s:builtin_func.prompt_setprompt = {'min' : 2, 'max': 2}
let s:builtin_func.pumvisible = {'min' : 0, 'max': 0}
let s:builtin_func.py3eval = {'min' : 1, 'max': 1}
let s:builtin_func.pyeval = {'min' : 1, 'max': 1}
let s:builtin_func.pyxeval = {'min' : 1, 'max': 1}
let s:builtin_func.range = {'min' : 1, 'max': 3}
let s:builtin_func.readfile = {'min' : 1, 'max': 3}
let s:builtin_func.reg_executing = {'min' : 0, 'max': 0}
let s:builtin_func.reg_recording = {'min' : 0, 'max': 0}
let s:builtin_func.reltime = {'min' : 0, 'max': 2}
let s:builtin_func.reltimefloat = {'min' : 1, 'max': 1}
let s:builtin_func.reltimestr = {'min' : 1, 'max': 1}
let s:builtin_func.remote_expr = {'min' : 2, 'max': 4}
let s:builtin_func.remote_foreground = {'min' : 1, 'max': 1}
let s:builtin_func.remote_peek = {'min' : 1, 'max': 2}
let s:builtin_func.remote_read = {'min' : 1, 'max': 2}
let s:builtin_func.remote_send = {'min' : 2, 'max': 3}
let s:builtin_func.remote_startserver = {'min' : 1, 'max': 1}
...
let s:builtin_func.setbufline = {'min' : 3, 'max': 3}
let s:builtin_func.setbufvar = {'min' : 3, 'max': 3}
let s:builtin_func.setcharsearch = {'min' : 1, 'max': 1}
let s:builtin_func.setcmdpos = {'min' : 1, 'max': 1}
let s:builtin_func.setfperm = {'min' : 2, 'max': 2}
let s:builtin_func.setline = {'min' : 2, 'max': 2}
let s:builtin_func.setloclist = {'min' : 2, 'max': 4}
let s:builtin_func.setmatches = {'min' : 1, 'max': 1}
let s:builtin_func.setpos = {'min' : 2, 'max': 2}
let s:builtin_func.setqflist = {'min' : 1, 'max': 3}
...
let s:builtin_func.strcharpart = {'min' : 2, 'max': 3}
let s:builtin_func.strchars = {'min' : 1, 'max': 2}
let s:builtin_func.strdisplaywidth = {'min' : 1, 'max': 2}
let s:builtin_func.strftime = {'min' : 1, 'max': 2}
let s:builtin_func.strgetchar = {'min' : 2, 'max': 2}
...
let s:builtin_func.taglist = {'min' : 1, 'max': 2}
let s:builtin_func.tan = {'min' : 1, 'max': 1}
let s:builtin_func.tanh = {'min' : 1, 'max': 1}
let s:builtin_func.tempname = {'min' : 0, 'max': 0}
let s:builtin_func.term_dumpdiff = {'min' : 2, 'max': 3}
let s:builtin_func.term_dumpload = {'min' : 1, 'max': 2}
let s:builtin_func.term_dumpwrite = {'min' : 2, 'max': 3}
let s:builtin_func.term_getaltscreen = {'min' : 1, 'max': 1}
let s:builtin_func.term_getansicolors = {'min' : 1, 'max': 1}
let s:builtin_func.term_getattr = {'min' : 2, 'max': 2}
let s:builtin_func.term_getcursor = {'min' : 1, 'max': 1}
let s:builtin_func.term_getjob = {'min' : 1, 'max': 1}
let s:builtin_func.term_getline = {'min' : 2, 'max': 2}
let s:builtin_func.term_getscrolled = {'min' : 1, 'max': 1}
let s:builtin_func.term_getsize = {'min' : 1, 'max': 1}
let s:builtin_func.term_getstatus = {'min' : 1, 'max': 1}
let s:builtin_func.term_gettitle = {'min' : 1, 'max': 1}
let s:builtin_func.term_gettty = {'min' : 1, 'max': 2}
let s:builtin_func.term_list = {'min' : 0, 'max': 0}
let s:builtin_func.term_scrape = {'min' : 2, 'max': 2}
let s:builtin_func.term_sendkeys = {'min' : 2, 'max': 2}
let s:builtin_func.term_setansicolors = {'min' : 2, 'max': 2}
let s:builtin_func.term_setkill = {'min' : 2, 'max': 2}
let s:builtin_func.term_setrestore = {'min' : 2, 'max': 2}
let s:builtin_func.term_setsize = {'min' : 3, 'max': 3}
let s:builtin_func.term_start = {'min' : 2, 'max': 2}
let s:builtin_func.term_wait = {'min' : 1, 'max': 2}
let s:builtin_func.test_alloc_fail = {'min' : 3, 'max': 3}
let s:builtin_func.test_autochdir = {'min' : 0, 'max': 0}
let s:builtin_func.test_feedinput = {'min' : 0, 'max': 0}
let s:builtin_func.test_garbagecollect_now = {'min' : 0, 'max': 0}
let s:builtin_func.test_ignore_error = {'min' : 1, 'max': 1}
let s:builtin_func.test_null_channel = {'min' : 0, 'max': 0}
let s:builtin_func.test_null_dict = {'min' : 0, 'max': 0}
let s:builtin_func.test_null_job = {'min' : 0, 'max': 0}
let s:builtin_func.test_null_list = {'min' : 0, 'max': 0}
let s:builtin_func.test_null_partial = {'min' : 0, 'max': 0}
let s:builtin_func.test_null_string = {'min' : 0, 'max': 0}
let s:builtin_func.test_override = {'min' : 2, 'max': 2}
let s:builtin_func.test_settime = {'min' : 1, 'max': 1}
let s:builtin_func.timer_info = {'min' : 0, 'max': 1}
let s:builtin_func.timer_pause = {'min' : 2, 'max': 2}
let s:builtin_func.timer_start = {'min' : 2, 'max': 3}
let s:builtin_func.timer_stop = {'min' : 1, 'max': 1}
let s:builtin_func.timer_stopall = {'min' : 0, 'max': 0}
let s:builtin_func.tolower = {'min' : 1, 'max': 1}
let s:builtin_func.toupper = {'min' : 1, 'max': 1}
let s:builtin_func.tr = {'min' : 3, 'max': 3}
let s:builtin_func.trim = {'min' : 1, 'max': 2}
...
let s:builtin_func.win_findbuf = {'min' : 1, 'max': 1}
let s:builtin_func.win_getid = {'min' : 0, 'max': 2}
let s:builtin_func.win_gotoid = {'min' : 1, 'max': 1}
let s:builtin_func.win_id2tabwin = {'min' : 1, 'max': 1}
let s:builtin_func.win_id2win = {'min' : 1, 'max': 1}
let s:builtin_func.win_screenpos = {'min' : 1, 'max': 1}
...
let s:builtin_func.wordcount = {'min' : 0, 'max': 0}
